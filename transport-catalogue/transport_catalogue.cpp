...
const Bus* TransportCatalogue::GetRoute(string_view name) {
...
const Stop* TransportCatalogue::GetStop(string_view name) {
...
uint64_t TransportCatalogue::GetStopDistance(const Stop* p_stop1, const Stop* p_stop2) {
    if (p_stop1 != nullptr && p_stop2 != nullptr) {
...
BusStat TransportCatalogue::GetStatistics(const Bus* bus) {
    BusStat statistics;
