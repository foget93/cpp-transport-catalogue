...
RenderSettings::RenderSettings(const RenderSettings& from)
  ...
  if (from._internal_has_bus_label_offset()) {
    _this->_impl_.bus_label_offset_ = new ::transport_catalogue_serialize::Point(*from._impl_.bus_label_offset_);
  }
  if (from._internal_has_stop_label_offset()) {
    _this->_impl_.stop_label_offset_ = new ::transport_catalogue_serialize::Point(*from._impl_.stop_label_offset_);
  }
...
void RenderSettings::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_has_bus_label_offset()) {
    _this->_internal_mutable_bus_label_offset()->::transport_catalogue_serialize::Point::MergeFrom(
        from._internal_bus_label_offset());
  }
  if (from._internal_has_stop_label_offset()) {
    _this->_internal_mutable_stop_label_offset()->::transport_catalogue_serialize::Point::MergeFrom(
